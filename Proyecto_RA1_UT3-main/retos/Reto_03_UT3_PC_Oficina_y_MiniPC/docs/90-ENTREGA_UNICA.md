...
- **Precio (€):** 169,90€ 
- **URL tienda:** [Intel Core i3‑14100 en PCComponentes](https://www.pccomponentes.com/intel-core-i3-14100-35-47ghz-box)

**Ficha técnica oficial (obligatorio):**  
- [Intel Core i3‑14100 Specs](https://www.intel.com/content/www/us/en/products/sku/236774/intel-core-i3-processor-14100-12m-cache-up-to-4-70-ghz/specifications.html)

**Características principales (resumen):**  
- 4 núcleos / 8 hilos, Base 3,5 GHz / Turbo 4,7 GHz  
- Caché L3 12 MB, gráfica integrada Intel UHD 730  
- Soporta DDR4‑3200 / DDR5‑4800, socket LGA 1700  
- TDP 60 W / Max Turbo Power 110 W

**Justificación (oficina):**  
- Graficos necesaarios para oficina basica ,ademas, de tener un buen multitasking y rendimiento
...
**Componente elegido:**  
- **Marca y modelo:** Biostar H610MHC 2.0  
- **Precio (€):** 61,27€ 
...
- 2 × slots DDR4, hasta 64 GB, 3200 MT/s  
- 1 × PCIe 4.0 ×16 + 1 × PCIe 3.0 ×1  
- 1 × ranura M.2 + 4 × SATA III

**Justificación (oficina):**  
- Es una placa base sencilla ,ademas, de tener un buen rendimiento en oficina y tiene expasion para el futuro si es necesario.
...
**Componente elegido:**  
- **Marca y modelo:** Silicon Power A55 256 GB M.2 2280 SATA III  
- **Precio (€):** 51,99€  
...
- Soporta TRIM, NCQ, S.M.A.R.T.

**Justificación (oficina):**  
- Memoria necesaria para oficina ,ademas de qye hace que se arranque mas rapidas las aplicaciones por su velocidad
...
**Componente elegido:**  
- **Marca y modelo:** Tacens Anima APIII750 750 W 85+ Bronze  
- **Precio (€):** 29,90€  
...
- Ventilador 120 mm, formato ATX estándar

**Justificación (oficina):**  
- Potencia suficiente para el sistema y futuras ampliaciones. Bajo ruido y eficiencia aceptable.
...
**Componente elegido:**  
- **Marca y modelo:** Einarex Pulse P100 Core ATX  
- **Precio (€):** 32,85€  
...
- Soporta placas Micro‑ATX y ATX  
- Hasta 6 ventiladores, espacio para SSD/HDD

**Justificación (oficina):**  
- Compacta, silenciosa, suficiente espacio para PC de oficina y futuras ampliaciones.
...
**Producto elegido:**  
- **Marca y modelo exacto:** Withtech Mini PC Intel J3710/8GB/64GB  
- **Precio (€):** 139 €  
- **URL tienda:** [PCComponentes](https://www.pccomponentes.com/withtech-mini-pc-intel-j3710-8gb-64gb)

**Ficha técnica oficial (obligatorio):**  
- URL oficial del fabricante: [PCComponentes — Ficha técnica](https://www.pccomponentes.com/withtech-mini-pc-intel-j3710-8gb-64gb)

**Especificaciones:**
- CPU: Intel J3710, 4 núcleos / 4 hilos, frecuencia base adecuada para tareas básicas  
- RAM: 8 GB DDR4  
- SSD/almacenamiento: 64 GB M.2 SSD (slot adicional disponible para ampliación)  
- Conectividad (Wi‑Fi/Ethernet/USB/vídeo): Wi‑Fi, Bluetooth, Ethernet Gigabit, 2×USB 2.0, 2×USB 3.2 Gen1, HDMI, VGA, salida audio, slot MicroSD  
- Tamaño / consumo (si aparece en ficha): ≈120×120×22 mm / bajo consumo, muy silencioso

**Ventajas:**
- Mini PC **listo para usar**, no requiere montaje ni configuración  
- Ocupa muy poco espacio, ideal para escritorios pequeños  
- Silencioso y eficiente en consumo eléctrico  
- Slot M.2 adicional para ampliar almacenamiento fácilmente

**Contras:**
- CPU limitada, no adecuada para multitarea pesada o programas exigentes  
- RAM fija a 8 GB, no ampliable  
- Almacenamiento base muy limitado (64 GB)  
- GPU integrada básica, no apta para edición de vídeo o juegos

**¿Para qué oficina SÍ / para qué NO?**
- Sí: navegación web, ofimática, correo, streaming, tareas básicas de productividad  
- No: edición de vídeo pesada, CAD, multitarea intensiva o software que requiera GPU dedicada

**Compatibilidad/ampliación (con enlaces):**
- ¿Se puede ampliar RAM? evidencia: No, RAM soldada al sistema [PCComponentes](https://www.pccomponentes.com/withtech-mini-pc-intel-j3710-8gb-64gb)  
- ¿Se puede ampliar SSD? evidencia: Sí, ranura M.2 disponible para SSD adicional [PCComponentes](https://www.pccomponentes.com/withtech-mini-pc-intel-j3710-8gb-64gb)
...
| Facilidad de despliegue | Requiere montaje y configuración | Listo para usar |
| Garantía/soporte | Garantías individuales por componente | Garantía unificada del mini PC |
...
|---|---|:--:|
| RAM ampliable (sí/no, máximo) | [Withtech Mini PC — RAM 8 GB DDR4, soldada](https://www.pccomponentes.com/withtech-mini-pc-intel-j3710-8gb-64gb) | ❌ |
| SSD ampliable (sí/no, M.2/SATA) | [Withtech Mini PC — slot M.2 libre para SSD adicional](https://www.pccomponentes.com/withtech-mini-pc-intel-j3710-8gb-64gb) | ✅ |
| Conectividad (Wi‑Fi/Ethernet/USB/HDMI/DP) | [Withtech Mini PC — puertos y conectividad](https://www.pccomponentes.com/withtech-mini-pc-intel-j3710-8gb-64gb) | ✅ |
